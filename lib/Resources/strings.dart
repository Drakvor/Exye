class StringResources {
  ...
  final String bConfirmPurchase2 = "계좌이체완료";
...
110-530-316299""";
  ...
  final String eAccountExists = "이 전화번호로 인증된 계정이 벌써 있습니다.";
  ...
  //paragraphs
  final String pSignUp1 = "오직 초대를 통한 서비스";
  final String pSignUp1a = "저희 서비스는 초대권을 통해 서비스 가입이 가능해요. 아직 서비스 초기라 모든 분들께 제공할 수 없어서 죄송해요. 빠른 시일내 더 많은 분들이 사용하실 수 있도록 준비해 두겠습니다.";
...
한남동""";
  ...
  //calendar
  final String cSlot1 = "오전";
  final String cSlot2 = "오후";
  final String cYear = "년";
