...
class FontResources {
  ...
  final TextStyle landing = const TextStyle(fontFamily: "Spoqa", fontSize: 14, fontWeight: FontWeight.w400, color: Color(0xff000000), height: 1.5);
  ...
  final TextStyle pBold = const TextStyle(fontFamily: "Spoqa", fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xff000000),);
  final TextStyle thick = const TextStyle(fontFamily: "Spoqa", fontSize: 14, fontWeight: FontWeight.w700, color: Color(0xff000000),);
  final TextStyle small = const TextStyle(fontFamily: "Spoqa", fontSize: 12, fontWeight: FontWeight.w400, color: Color(0xff000000),);
  ...
  final TextStyle paragraph = const TextStyle(fontFamily: "Spoqa", fontSize: 14, fontWeight: FontWeight.w300, color: Color(0xff000000),);
  final TextStyle header = const TextStyle(fontFamily: "Spoqa", fontSize: 16, fontWeight: FontWeight.w700, color: Color(0xff000000),);
  final TextStyle headerLarge = const TextStyle(fontFamily: "Spoqa", fontSize: 18, fontWeight: FontWeight.w700, color: Color(0xff000000),);
  final TextStyle headerLight = const TextStyle(fontFamily: "Spoqa", fontSize: 18, fontWeight: FontWeight.w300, color: Color(0xff000000),);
  final TextStyle title = const TextStyle(fontFamily: "Spoqa", fontSize: 28, fontWeight: FontWeight.w700, color: Color(0xff000000),);
  final TextStyle smallThick = const TextStyle(fontFamily: "Spoqa", fontSize: 11, fontWeight: FontWeight.w700, color: Color(0xff000000),);
  final TextStyle smaller = const TextStyle(fontFamily: "Spoqa", fontSize: 11, fontWeight: FontWeight.w400, color: Color(0xff000000),);
